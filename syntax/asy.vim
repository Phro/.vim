...
syn region	asySingleString	start=+'+ skip=+\\\\\|\\'+ end=+'+ contains=asySpecial
...
if exists("asy_no_bracket_error")
  ...
  syn region	asyCppParen	transparent start='(' skip='\\$' excludenl end=')' end='$' contained contains=ALLBUT,@asyParenGroup,asyParen,asyString,asySingleString
  ...
  " asyCppParen: same as asyParen but ends at end-of-line; used in asyDefine
  syn region	asyCppParen	transparent start='(' skip='\\$' excludenl end=')' end='$' contained contains=ALLBUT,@asyParenGroup,asyErrInBracket,asyParen,asyBracket,asyString,asySingleString
if 0
  syn match	asyParenError	display "[\])]"
  syn match	asyErrInParen	display contained "[\]]"
endif
  ...
  syn region	asyCppBracket	transparent start='\[' skip='\\$' excludenl end=']' end='$' contained contains=ALLBUT,@asyParenGroup,asyErrInParen,asyParen,asyBracket,asyString,asySingleString
...
if version >= 508 || !exists("did_asy_syn_inits")
  ...
  HiLink asyCppString		asySingleString
  ...
  HiLink asyIncluded		asySingleString
  ...
  HiLink asyCommentString		asySingleString
  HiLink asyComment2String	asyString
  HiLink asyComment2String	asySingleString
  HiLink asyCommentSkip		asyComment
  HiLink asyString		String
  HiLink asySingleString	String
